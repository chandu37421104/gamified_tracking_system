        ...
        <div className="hidden w-full md:block md:w-auto">
          <ul className="font-medium flex flex-col p-4 md:p-0 mt-4 border border-gray-100 rounded-lg bg-gray-50 md:flex-row md:space-x-8 rtl:space-x-reverse md:mt-0 md:border-0 md:bg-white dark:bg-gray-800 md:dark:bg-gray-900 dark:border-gray-700">
            <li>
              <Link
                to="/dashboard"
                className={`block py-2 px-3 ${isActive('/dashboard') ? 'text-blue-700' : 'text-white'} hover:text-blue-700`}
              >
                Dashboard
              </Link>
            </li>
            <li>
              <Link
                to="/tasks"
                className={`block py-2 px-3 ${isActive('/tasks') ? 'text-blue-700' : 'text-white'} hover:text-blue-700`}
              >
                Tasks
              </Link>
            </li>
            ...
            <li>
              <Link
                to="/rewards"
                className={`block py-2 px-3 ${isActive('/rewards') ? 'text-blue-700' : 'text-white'} hover:text-blue-700`}
              >
                Rewards
              </Link>
            </li>

  ...
  return (
    <nav className="bg-white border-gray-200 dark:bg-gray-900">
      <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
        <Link to="/pidashboard" className="flex items-center space-x-3 rtl:space-x-reverse">
          <img
        ...
        <div className="hidden w-full md:block md:w-auto">
          <ul className="font-medium flex flex-col p-4 md:p-0 mt-4 border border-gray-100 rounded-lg bg-gray-50 md:flex-row md:space-x-8 rtl:space-x-reverse md:mt-0 md:border-0 md:bg-white dark:bg-gray-800 md:dark:bg-gray-900 dark:border-gray-700">
            <li>
              <Link
                to="/pidashboard"
                className={`block py-2 px-3 ${isActive('/pidashboard') ? 'text-blue-700' : 'text-white'} hover:text-blue-700`}
              >
                Dashboard
              </Link>
            </li>
            <li>
              <Link
                to="/pitask"
                className={`block py-2 px-3 ${isActive('/pitask') ? 'text-blue-700' : 'text-white'} hover:text-blue-700`}
              >
                Tasks
              </Link>
            </li>
            ...
            <li>
              <Link
                to="/pirewards"
                className={`block py-2 px-3 ${isActive('/pirewards') ? 'text-blue-700' : 'text-white'} hover:text-blue-700`}
              >
                Rewards
              </Link>
            </li>
